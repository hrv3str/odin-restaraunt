import menuSmoothiePhoto from './menu-smoothie.jpg';
import menuTeaPhoto from './menu-tea.jpg';
import menuLattePhoto from './menu-latte.jpg';
import menuLemonadePhoto from './menu-lemonade.jpg';
import menuBrowniePhoto from './menu-brownie.jpg';
import menuBurgerPhoto from './menu-burger.jpg';
import menuCaesarPhoto from './menu-caesar.jpg';
import menuCheesecakePhoto from './menu-cheezecake.jpg';
import menuMidteranianPhoto from './menu-midteranian.jpg';
import menuMozzarellaPhoto from './menu-mozzarella.jpg';
import menuOnionPhoto from './menu-onion.jpg';
import menuPizzaPhoto from './menu-pizza.jpg';
...
export const createMenuContent = () => {
    ...
    createDishCard(smoothieTitle, smoothieDesc, smooothiePrice, menuSmoothiePhoto);
    ...
    createDishCard(raspberryTeaTitle, raspberryTeaDesc, raspberryTeaPrice, menuTeaPhoto);
    ...
    createDishCard(lemonadeTitle, lemonadeDesc, lemonadePrice, menuLemonadePhoto);
    ...
    createDishCard(latteTitle, latteDesc, lattePrice, menuLattePhoto);
    ...
    createDishCard(mozzarellaSticksTitle, mozzarellaSticksDesc, mozzarellaSticksPrice, menuMozzarellaPhoto);
    ...
    createDishCard(onionRingsTitle, onionRingsDesc, onionRingsPrice, menuOnionPhoto);
    ...
    createDishCard(caesarTitle, caesarDesk, caesarPrice, menuCaesarPhoto);
    ...
    createDishCard(quinoaSaladTitle, quinoaSaladDesk, quinoaSaladPrice, menuMidteranianPhoto);
    ...
    createDishCard(burgerTitle, burgerDesc, burgerPrice, menuBurgerPhoto);
    ...
    createDishCard(pizzaTitle, pizzaDesc, pizzaPrice, menuPizzaPhoto);
    ...
    createDishCard(brownieTitle, brownieDesc, browniePrice, menuBrowniePhoto);
    ...
    createDishCard(cheseCakeTitle, cheseCakeDesk, cheseCakePrice, menuCheesecakePhoto);
